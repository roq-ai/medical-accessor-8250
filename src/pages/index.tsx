...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Medical Accessories Store Online`}</title>

        <meta
          name="description"
          content="Experience Medwith, your Medical Accessories Store Online. We're a leading provider of hospital supplies and surgical instruments worldwide."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1516549655169-df83a0774514?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtZWRpY2FsJTIwZXF1aXBtZW50fGVufDB8fHx8MTY5NzYxNjA3M3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Medical Accessories Store Online`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Medwith, your Medical Accessories Store Online. We're a leading provider of hospital supplies and surgical instruments worldwide.`}
            </Text>
            <Box
